            ...
            <Box borderBottom={1} borderColor="divider">
                <Grid container wrap="nowrap">
                    ...
                    >
                        <Grid item>
                            <IconButton
                                href="https://github.com/rinchhen012/Hisab-Kitab"
                                target="_blank"
                            >
                                <GitHubIcon />
                            </IconButton>
            ...
            >
                <DialogTitle id="scroll-dialog-title">
                    <Typography display="flex" alignItems="center" justifyContent="center">
                        <VerticalSplit />
                        <Typography ml="0.65rem" fontWeight="bold" variant="h6">Hisab-Kitab - Split trip expenses with ease</Typography>
                    </Typography>
                </DialogTitle>
